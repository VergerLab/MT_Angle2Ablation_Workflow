...
macro "SimuAblation-Cell_RoiMaker_timelapse Action Tool - C000 T0508R T6508O Td508I T0h08M T4h08a T9h08k Teh08e Tjh08r" {
///======================MACRO=========================///
...
///Ask the user about fibril tool parameters
  ...
  Dialog.addNumber("Line width thickness\t", 2);
...
macro "All_Angle2Ablation_timelapse Action Tool - C000 T0508A T6508l Ta508l Tc508_ T0h08A T6h082 Tch08A" {
///======================MACRO=========================///
