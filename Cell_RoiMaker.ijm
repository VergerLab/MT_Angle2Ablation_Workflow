...
As input you need 2D images of cell contours (e.g. ..._cells.tif) and a 
matching 2D image containing the feature of interest such as mircotubule 
arrays (e.g. ..._MTs.tif). These can be created using the ImageJ macro 
...
This macro can replace the Segmentation4FTBatch macro
