///======================MACRO=========================///
macro_name = "Line_RoiMaker_timelapse";
///====================================================///
...
It is modified from the simple Line_RoiMaker, to create 
...
*/
macro_source = "https://github.com/VergerLab/MT_Angle2Ablation_Workflow/Line_RoiMaker_timelapse.ijm";
...
for (j=0; j<list.length; j++){
	...
	if(endsWith (list[j], contours_suffix)){
		...
		if(s>1){
			...
			roiManager("Open", dir + File.separator + Output_ROI_lines);
		}
